...
describe('qwarryBidAdapter', function () {
  ...
  describe('buildRequests', function () {
    ...
    it('sends bid request to ENDPOINT via POST', function () {
      ...
      expect(bidderRequest.data).to.equal({})
  ...
  describe('interpretResponse', function () {
    it('handles banner request : should get correct bid response', function () {
      ...
      expect(result[0]).to.have.property('width').to.be.below(640)
      expect(result[0]).to.have.property('height').to.be.below(480)
    ...
    it('handles video request : should get correct bid response', function () {
      ...
      expect(result[0]).to.have.property('currency').equal('USD')
      expect(result[0]).to.have.property('width').to.be.below(1024)
      expect(result[0]).to.have.property('height').to.be.below(768)
